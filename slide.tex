...
\begin{frame}{Istanza}
  ...
  \item $s = \bra{s_i}$ vettore delle sorgenti,
  \item $t = \bra{t_i}$ vettore delle destinazioni,
  \item $P = \cup _i P_i$ con $P_i$ insieme dei
    percorsi da $s_i$ a $t_i$,
  \item $X = \bra{X_i}$ dove $X_i$ rappresenta la quantità di
    traffico da instradare da $s_i$ a $t_i$,
  \item $l = \bra{l_j}$ dove $l_j(x_j)$ è il costo del link
  ...
  le $l_i$ rispettivamente affine e convesse.
\end{frame}
...
\begin{frame}{Soluzione di un'instanza e suo costo}
  ...
  \item $\displaystyle \forall j\in A\;\; x_j = \sum_{p\in P,j\in p} x_p$,
  \item $\displaystyle \forall i\;\; \sum_{p\in P_i} x_p = X_i$
  \end{itemize}
